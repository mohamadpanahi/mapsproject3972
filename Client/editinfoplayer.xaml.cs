...
namespace testui
{
    ...
    /// </summary>
    public sealed partial class editinfoplayer : Page
    {
        private Player acc;
        public editinfoplayer()
        {
        ...
        private void Page_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            dat_birth.Date = acc.birth;
            txt_stature.Text = acc.stature;
            txt_weight.Text = acc.weight;
            switch (acc.sport)
            {
        ...
        {
            if (txt_name.Text == "" || txt_email.Text == "" || txt_phone.Text == "" || txt_code.Text == "" || txt_password.Password == "" || txt_confirmpassword.Password == "" || txt_password.Password != txt_confirmpassword.Password || txt_weight.Text == "" || txt_stature.Text == "")
            {
            ...
            else
            {
                ...
                bool res = await acc.edit(acc.Username, acc.Password, txt_name.Text, txt_email.Text, txt_code.Text, txt_phone.Text, (bool)rbtn_man.IsChecked, txt_password.Password, txt_stature.Text, txt_weight.Text, dat_birth.Date);
                if (res)
                {
